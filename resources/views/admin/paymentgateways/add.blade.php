						...
						<div class="col-md-12">
                            <div class="card">
                                <div class="card-body pt-2 pb-3 manageClinicSection">
									...
									<form action="{{route('paymentgateway.create')}}" method="post" class="user" id="add_genre_form" enctype="multipart/form-data">
										@csrf												
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														<label>Name<span class="required">*</span></label>
														<input type="text" name="name" id="name" value="{{old('name')}}" class="form-control form-control-user" required placeholder="Payment gateway name" />
														@if ($errors->has('name'))
												...
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<select name="payment_mode" id="payment_mode" class="form-control form-control-user" required>
															...
															<option value="Live" {{ old('payment_mode') == 'Live'  ? 'selected' : ''}}>Live</option>
															<option value="Test" {{ old('payment_mode') == 'Test'  ? 'selected' : ''}}>Test</option>
														</select>
											...
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="api_key" id="api_key" value="{{old('api_key')}}" class="form-control form-control-user" required/>
												...
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="secret_key" id="secret_key" value="{{old('secret_key')}}" class="form-control form-control-user" required />
											...
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="sandbox_url" id="sandbox_url" value="{{old('sandbox_url')}}" class="form-control form-control-user" required/>
												...
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="live_url" id="live_url" value="{{old('live_url')}}" class="form-control form-control-user" required />
											...
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="email" name="email" id="email" value="{{old('email')}}" class="form-control form-control-user" required/>
														@if ($errors->has('email'))
											...
											<div class="mt-1 mb-1">
												<div class="text-left d-print-none mt-4">
													<button type="submit" id="save-paymentgateway-btn" class="btn btn-primary">Save</button>
