						...
						<div class="col-md-12">
                            <div class="card">
                                <div class="card-body pt-2 pb-3 manageClinicSection">
									...
									<form action="{{route('user.updatepassword')}}" method="post" class="user" id="add_genre_form" >
										@csrf	
											...
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="password" name="password" id="password" value="{{old('password')}}" class="form-control form-control-user" required />
											...
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="password" name="password_confirmation" id="password_confirmation" value="{{old('password_confirmation')}}" class="form-control form-control-user" required />
