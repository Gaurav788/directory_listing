											...
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="name" id="name" value="{{$record->name}}" class="form-control form-control-user" required />
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<textarea  name="details" class="form-control form-control-user" required /> {{$record->details}}</textarea>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="currency" id="currency" value="{{$record->currency}}" class="form-control form-control-user" required />
													</div>
												</div>
											</div>									
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="number" name="price" id="price" value="{{$record->price}}" class="form-control form-control-user" required />
													</div>
												</div>
											</div>									
											<div class="row">
