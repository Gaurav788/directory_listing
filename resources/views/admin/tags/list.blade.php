			...
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<div class="buttons-right">
						<a class="m-0 font-weight-bold btn-department-add pull-right hover-white" href="{{route('tag.add')}}">Add Tag</a>
					</div>
				</div>
				<div class="card-body">
						...
						<table id="artistlisting-datatable" class="table table-hover dt-responsive nowrap">
							...
							<tbody>
								...
								<tr>
									...
									<td>
									@if($row->status == 0)
										<a title="Click to Enable" href="{{route('tag.status', ['g' => $row->id, 's' => 1])}}" class="tableLink"><img alt="Click to Enable" src="/assets/images/off.png" /></a>&nbsp;Disabled
									@else
										<a title="Click to Disable" href="{{route('tag.status', ['g' => $row->id, 's' => 0])}}" class="tableLink"><img title="Click to Disable" src="/assets/images/on.png" /></a>&nbsp;Enabled
									@endif
									</td>
